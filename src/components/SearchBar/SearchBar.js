...
class SearchBar extends React.Component {
  ...
  getSortByClass(sortByOption){
    if (sortByOption === this.state.sortBy) {
      return 'active'; //this will help to set the css class to active for whichever sortby option is selected
    }
    return '';
  }

  handleSortByChange(sortByOption) {
    this.setState({ sortBy: sortByOption }); //sets the state to whichever sortBY option has been selected
  }
